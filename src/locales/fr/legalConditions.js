/** Conditions générales d'utilisation (français, version qui fait foi). */
export default {
    seo: {
            ...
            articles: [
                {
                    ...
                    paragraphs: [
                        "LivSight assure des livraisons à Yaoundé dans les zones couvertes par l'agence. Toute commande passée en dehors des zones définies peut être refusée ou tarifée différemment. Les délais annoncés sont indicatifs et peuvent varier selon les conditions de circulation, la météo ou la disponibilité des livreurs.",
                    ],
                },
                {
                    art: 2,
                ...
                },
                {
                    ...
                    paragraphs: [
                        "En cas de client absent, injoignable ou de refus de réception, le colis est retourné à l'agence. Des frais de retour peuvent s'appliquer. LivSight ne saurait être tenu responsable des pertes commerciales liées à un échec de livraison imputable au destinataire.",
                    ],
                },
            ],
        },
        {
            title: "Paiement & reversement",
            articles: [
                {
                    art: 4,
            ...
            articles: [
                {
                    ...
                    paragraphs: [
                        "LivSight se réserve le droit de suspendre immédiatement un compte commerçant en cas de fausses déclarations, de commandes fictives répétées, de colis non conformes ou de dette non régularisée après mise en demeure. La suspension n'exonère pas le commerçant de ses dettes envers l'agence.",
                    ],
                },
                {
                    art: 11,
