/**
 * Page « L'application commerçant » : textes de la maquette « Site web ».
 *
...
export const applicationSoon = {
    ...
    tabs: [
        {
            id: "planning",
            label: "Le planning du jour",
            caption: "Chaque enlèvement, chaque livraison, l'heure du reversement.",
            lift: 17,
        },
        {
            id: "livreur",
            label: "Où est votre livreur",
            caption: "Sa position sur la carte, l'ordre de sa tournée, le temps restant.",
            lift: 0,
        },
        {
            id: "retrait",
            label: "Retrait à la demande",
            caption: "Votre solde en direct, retirable quand vous voulez dans la journée.",
            lift: 17,
        },
    ],
    columns: [
...
export const applicationInstall = {
