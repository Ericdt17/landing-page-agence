    ...
    <section id='offre' className='relative scroll-mt-24'>
      <div className='max-container px-6 py-10 sm:px-10 sm:py-14 lg:px-14'>
        <div className='mx-auto max-w-3xl text-center'>
          <span className='inline-flex max-w-full items-center rounded-full bg-brand-ink px-4 py-1.5'>
          ...
          <p className='mt-4 font-montserrat text-base font-semibold leading-7 text-brand-ink sm:text-lg'>
            {offreSubheadline}
          </p>
        </div>
