        ...
        <div className='py-12 sm:py-16'>
            ...
            <ul className='mt-10 grid list-none grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-6'>
                {coursesParticuliersHighlights.map(({ title, body }) => (
                    <li
                        key={title}
                        className='rounded-2xl border border-ls-rule bg-ls-fill px-5 py-5 text-center sm:px-6'
                    >
                        <p className='font-montserrat text-lg font-bold text-ls-accent'>
                            {title}
                        </p>
                        <p className='mt-2 font-montserrat text-sm text-ls-muted'>
                            {body}
                        </p>
                    </li>
                ))}
            ...
            <div className='mt-10 rounded-2xl border border-ls-rule bg-ls-fill px-6 py-5 text-center sm:px-8'>
                ...
                <p className='mt-1 font-montserrat text-sm leading-relaxed text-ls-muted sm:text-base'>
                    {coursesParticuliersPricingBody}
                </p>
            </div>
