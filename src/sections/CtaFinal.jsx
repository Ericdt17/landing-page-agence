          ...
          <div className='relative px-6 py-10 text-center sm:px-10 sm:py-14 lg:px-20 lg:py-20'>
            ...
            <div className='mt-8 flex justify-center sm:mt-10'>
              <a
                ...
                className='inline-flex min-h-[54px] min-w-0 items-center justify-center gap-2 rounded-full bg-white px-8 font-montserrat text-base font-bold text-brand-ink shadow-lg transition-opacity hover:opacity-95 sm:min-h-[70px] sm:min-w-[200px] sm:px-10 sm:text-lg'
              >
