/** Page Sécurité (français, version qui fait foi). */
export default {
    seo: {
        title: "Sécurité",
        description: "Les engagements de LivSight sur l'identification des livreurs, la protection de vos données et la sécurité financière.",
    },
    title: "Sécurité",
    updated: "Dernière mise à jour : avril 2026",
    intro: "Cette page présente les engagements de LivSight en matière d'identification des livreurs, de protection de vos données et de sécurité financière. Elle complète notre politique de confidentialité.",
    contactIntro: "Pour toute question ou signalement, notre équipe est joignable aux coordonnées ci-dessous.",
    agency: {
        whatsappLabel: "WhatsApp / Téléphone :",
        whatsappLink: "Ouvrir le WhatsApp officiel de LivSight",
        emailLabel: "Email :",
        addressLabel: "Adresse :",
        address: "Hippodrome, Yaoundé, Cameroun",
    },
    groups: [
        {
            title: "Identité & livreurs",
            articles: [
                {
                    art: 1,
                    ...
                    highlight: "Un vrai livreur LivSight ne vous demandera jamais de payer plus que le montant indiqué à la commande.",
                },
                {
                    art: 2,
        ...
        },
        {
            ...
            articles: [
                ...
                },
                {
                    ...
                    paragraphs: [
                        "Votre numéro de téléphone est utilisé uniquement pour coordonner la livraison (appel ou message du livreur, confirmation de passage). Il ne sera jamais utilisé à des fins commerciales ou publicitaires, ni partagé à des tiers sans votre consentement explicite.",
                    ],
                },
                {
                    art: 5,
                    ...
                    paragraphs: [
                        "La géolocalisation est activée uniquement sur les appareils des livreurs, avec leur consentement explicite, pendant les heures de service. Cette donnée est visible par l'agent de l'agence pour organiser les tournées. Elle n'est ni stockée de façon permanente ni partagée avec des tiers.",
                    ],
                },
            ],
        },
            ...
            articles: [
                {
                    ...
                    highlight: "Si quelqu'un vous demande un virement ou un dépôt au nom de LivSight avant livraison, il s'agit d'une tentative de fraude. Contactez-nous immédiatement.",
                },
                {
                    art: 7,
