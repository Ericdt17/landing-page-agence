/**
 * Page « Technologie » (français) : chaque affirmation a été vérifiée dans le code.
 *
 ...
 * - pas de « montant verrouillé », ni de file d'actions hors ligne.
 */
export default {
    seo: {
        title: "Technologie",
    ...
    hero: {
        ...
        stack: ["Backend typé", "API interne", "Base transactionnelle", "Tâches asynchrones", "Géolocalisation", "Applications mobiles", "Web"],
    ...
    asideLabel: "API et recrutement",
    figures: {
        route: { stops: "6 arrêts · une tournée", saving: "−5 % de distance" },
        whatsapp: {
        ...
        field: [
            "Positions gardées sur le téléphone · hors réseau",
            "Réseau revenu · 12 positions envoyées",
            "Adresse hors zone de service · refusée",
        ],
    },
    recrutement: {
