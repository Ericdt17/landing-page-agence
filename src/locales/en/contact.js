...
export default {
    seo: {
        title: "Contact",
        description:
            "Message LivSight on WhatsApp, reply within 10 minutes during opening hours, or by email. Hippodrome, Yaoundé.",
    },
    hero: {
        kicker: "Contact",
        title: "We reply fast. Really.",
        lede: "WhatsApp is the fastest channel: a reply within 10 minutes during opening hours, with a written record of your request.",
    },
    channelsLabel: "Reach us",
    channels: {
        whatsapp: { title: "WhatsApp", text: "Reply within 10 min · the fastest channel", cta: "Message us on WhatsApp" },
