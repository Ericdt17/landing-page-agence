/** Politique de confidentialité (français, version qui fait foi). */
export default {
    seo: {
        title: "Politique de confidentialité",
        description: "Quelles données LivSight collecte, pourquoi, combien de temps elles sont gardées et comment exercer vos droits.",
    },
    title: "Politique de confidentialité",
    updated: "Dernière mise à jour : septembre 2026",
    intro: "Ce document explique quelles données LivSight collecte, pourquoi, combien de temps nous les gardons et comment exercer vos droits. Il est établi au regard de la loi n° 2024/017 du 23 décembre 2024.",
    contactIntro: "Pour exercer vos droits ou pour toute question sur vos données, écrivez-nous :",
    sections: [
        {
            number: "01",
